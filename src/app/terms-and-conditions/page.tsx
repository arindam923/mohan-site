  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-4">
        Terms and Conditions for MDAllTechSolution
      </h1>

      <p className="mb-4">
        Welcome to MDAllTechSolution! These terms and conditions outline the
        rules and regulations for the use of MDAllTechSolution's Website,
        located at [Website URL].
      </p>
      <p className="mb-4">
        By accessing this website, we assume you accept these terms and
        conditions. Do not continue to use MDAllTechSolution if you do not agree
        to take all of the terms and conditions stated on this page.
      </p>

      <h2 className="text-2xl font-semibold mb-3">Cookies</h2>
      <p className="mb-4">
        We employ the use of cookies. By accessing MDAllTechSolution, you agreed
        to use cookies in agreement with the MDAllTechSolution's Privacy Policy.
      </p>

      <h2 className="text-2xl font-semibold mb-3">License</h2>
      <p className="mb-4">
        Unless otherwise stated, MDAllTechSolution and/or its licensors own the
        intellectual property rights for all material on MDAllTechSolution. All
        intellectual property rights are reserved. You may access this from
        MDAllTechSolution for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>
      <p className="mb-4">You must not:</p>
      <ul className="list-disc pl-5 mb-4">
        <li>Republish material from MDAllTechSolution</li>
        <li>Sell, rent, or sub-license material from MDAllTechSolution</li>
        <li>Reproduce, duplicate or copy material from MDAllTechSolution</li>
        <li>Redistribute content from MDAllTechSolution</li>
      </ul>
      ...
      <p className="mb-4">
        ...
        information in certain areas of the website. MDAllTechSolution does not
        ...
        MDAllTechSolution, its agents, and/or affiliates. Comments reflect the
        views and opinions of the person who posts their views and opinions. To
        the extent permitted by applicable laws, MDAllTechSolution shall not be
      ...
      <p className="mb-4">
        MDAllTechSolution reserves the right to monitor all Comments and to
