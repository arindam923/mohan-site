  ...
  return (
    <section className="container mt-5 mx-auto">
      ...
      <h3 className="lg:text-4xl text-2xl leading-normal font-semibold">
        {" "}
        What&apos;s our client say? <span></span>
      </h3>
      ...
      <div className="mt-5">
        {testimonies.map((item) => (
          <article
            key={item.id}
            className="bg-neutral-900 text-xs lg:text-sm lg:text-center max-w-4xl mx-auto p-10 rounded-md backdrop-blur-md bg-opacity-60 shadow-md"
          >
