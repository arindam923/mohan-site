...
export const BentoGridItem = ({
    ...
    return (
        <div
            className={cn(
                "row-span-1 relative rounded-xl group/bento  transition duration-200 shadow-input dark:shadow-none p-4 dark:bg-black dark:border-white/[0.2] border border-transparent justify-between flex flex-col space-y-4",
                className
            )}
        >

            <img src={image} className="absolute w-full h-full rounded-md object-cover" />
            {header}
