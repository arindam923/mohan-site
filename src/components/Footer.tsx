    ...
    return (
        <footer className="w-full container mx-auto p-10 pt-6 bg-black text-white ">
            <div className="grid grid-cols-4 gap-5">
                <div>
                    <h2 className="text-2xl font-semibold">Rev<span className="text-purple-600">V</span>Trex</h2>
                </div>
                <div>
                    <h3 className="mb-2">Let&apos;s connect</h3>
                    <p className="text-sm">GopalPura,217421,Jaipur,Rajasthan</p>
                </div>
                <div>
                    <h3 className="mb-2">Links</h3>
                    <p className="text-sm mb-1 text-stone-400">
                        Privacy Policy
                    </p>
                    <p className="text-sm mb-1 text-stone-400">
                        Terms & conditions
            ...
            <div className="border-t mt-2 w-full border-neutral-800 flex items-center justify-center">
                <p className="text-sm text-muted mt-2">&copy; 2023 MdAllTechSolutiions.  All rights reserved.</p>
